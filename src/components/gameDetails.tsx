        ...
        <article className="xl:w-6/12 place-self-end">
            ...
            <div className="md:pl-11">
                <div className="text-yellow-450 text-sm flex gap-6 items-center mb-6">
                    ...
                    <span className="before:content-personIconY before:inline-block before:mr-2 flex items-center">{peopleCount} осіб</span>
                    <span className="border-l-2 border-yellow-450 border-solid inline-block h-[14px]">&nbsp;</span>
                ...
                <button className="py-[14px] px-11 text-base font-semibold text-darkText-100 bg-yellow-450 rounded-md hover:brightness-200 focus:brightness-200" style={{ boxShadow: "0px 2px 30px 0px #FEC43280" }}>Взяти участь</button>
            </div>
        </article>
    );
}
